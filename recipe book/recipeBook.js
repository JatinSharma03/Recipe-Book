...
class NewPage{
    ...
    createSubNav(){
        let newSubNavbar = document.getElementById('newSubNavbar');
        newSubNavbar.classList.remove('invisible');
        
        let oldSubNavbar = document.getElementById('oldSubNavbar');
        oldSubNavbar.classList.add('invisible');
...
class OldPage{
    ...
    createMainSubNav(){
        let newSubNavbar = document.getElementById('newSubNavbar');
        newSubNavbar.classList.add('invisible');
        
        let oldSubNavbar = document.getElementById('oldSubNavbar');
        oldSubNavbar.classList.remove('invisible');
...
// search recipe
let searchRecipe;
searchRecipe = document.getElementById('searchRecipe');
